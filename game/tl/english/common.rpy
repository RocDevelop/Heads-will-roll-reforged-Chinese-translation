...
translate english strings:
    ...
    new "本菜单选项旨在提升可访问性。可能不兼容所有游戏，某些选项组合可能导致游戏无法运行。这并非游戏或引擎的问题。更改字体时，建议保持原始文本大小以获得最佳效果。"
    ...
    new "本程序包含多个许可证下的自由软件，包括MIT许可证和GNU宽松通用公共许可证。完整的软件列表及源代码链接请访问{a=https://www.renpy.org/l/license}此处{/a}。"
    ...
    new "自动语音将朗读\'[renpy.display.tts.last]\'。按'alt+shift+V'禁用。"
    ...
    new "\n{color=#cfc}✔ 预测图像 (良好){/color}\n{color=#fcc}✘ 未预测图像 (不良){/color}\n{color=#fff}拖动可移动。{/color}"
    ...
    new "DirectX网络安装程序已启动。它可能会最小化到任务栏。请按照提示安装DirectX。"

    # renpy/common/00gltest.rpy:272
    old "{b}Note:{/b} Microsoft's DirectX web setup program will, by default, install the Bing toolbar. If you do not want this toolbar, uncheck the appropriate box."
    new "{b}注意：{/b} 微软DirectX网络安装程序默认会安装Bing工具栏。如不需要，请取消勾选相应选项。"

    # renpy/common/00gltest.rpy:276
    old "When setup finishes, please click below to restart this program."
    new "安装完成后，请点击下方按钮重启程序。"
    ...
    new "将traceback.txt文件以BBcode格式复制到剪贴板，适用于https://lemmasoft.renai.us/等论坛。"
    ...
    new "将traceback.txt文件以Markdown格式复制到剪贴板，适用于Discord。"
    ...
    new "将errors.txt文件以BBcode格式复制到剪贴板，适用于https://lemmasoft.renai.us/等论坛。"

    # renpy/common/_errorhandling.rpym:687
    old "Copies the errors.txt file to the clipboard as Markdown for Discord."
    new "将errors.txt文件以Markdown格式复制到剪贴板，适用于Discord。"
...
translate english strings:
    ...
    new "本游戏需要使用GL2渲染器，但无法初始化。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a} 文件中可能包含有助于诊断计算机问题的信息。"

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "更多修复方法细节可在{a=[url]}文档{/a}中找到。"
